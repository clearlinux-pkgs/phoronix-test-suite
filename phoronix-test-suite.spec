...
Version  : 8.4.0m2
Release  : 39
URL      : https://github.com/phoronix-test-suite/phoronix-test-suite/archive/v8.4.0m2.tar.gz
Source0  : https://github.com/phoronix-test-suite/phoronix-test-suite/archive/v8.4.0m2.tar.gz
...
%prep
%setup -q -n phoronix-test-suite-8.4.0m2
%patch1 -p1
%patch2 -p1
...
export LANG=C
export SOURCE_DATE_EPOCH=1541430169
make  %{?_smp_mflags}
