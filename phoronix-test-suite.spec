...
Source0  : https://github.com/phoronix-test-suite/phoronix-test-suite/archive/v8.2.0.tar.gz
...
%prep
%setup -q -n phoronix-test-suite-8.2.0
%patch1 -p1
%patch2 -p1
...
export LANG=C
export SOURCE_DATE_EPOCH=1542210709
make  %{?_smp_mflags}
