...
Source0  : https://github.com/phoronix-test-suite/phoronix-test-suite/archive/v8.4.1.tar.gz
...
%prep
%setup -q -n phoronix-test-suite-8.4.1
%patch1 -p1
%patch2 -p1
...
export LANG=C
export SOURCE_DATE_EPOCH=1544482805
make  %{?_smp_mflags}
