...
Source0  : https://github.com/phoronix-test-suite/phoronix-test-suite/archive/v8.0.1.tar.gz
...
%prep
%setup -q -n phoronix-test-suite-8.0.1
%patch1 -p1
%patch2 -p1
...
export LANG=C
export SOURCE_DATE_EPOCH=1530566024
make  %{?_smp_mflags}
