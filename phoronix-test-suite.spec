...
Version  : 7.6.0
Release  : 31
URL      : https://www.phoronix.net/downloads/phoronix-test-suite/releases/phoronix-test-suite-7.6.0.tar.gz
Source0  : https://www.phoronix.net/downloads/phoronix-test-suite/releases/phoronix-test-suite-7.6.0.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1512653626
make  %{?_smp_mflags}
